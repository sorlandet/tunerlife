...
from src.libs.file_manager.models import MonAlbum, MonFichier
from src.libs.file_manager.serializers import AlbumSerializer, \
...
class TinymceView(TemplateView):
    template_name = 'file_manager/test.html'
...
class IndexView(TemplateView):
    template_name = 'file_manager/index.html'
