...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_otherserviceinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'account', ['OtherServiceInfo'])

        # Adding unique constraint on 'OtherServiceInfo', fields ['user', 'key']
        db.create_unique(u'account_otherserviceinfo', ['user_id', 'key'])

        # Adding model 'PasswordReset'
        db.create_table(u'account_passwordreset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('temp_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('reset', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'account', ['PasswordReset'])


    def backwards(self, orm):
        # Removing unique constraint on 'OtherServiceInfo', fields ['user', 'key']
        db.delete_unique(u'account_otherserviceinfo', ['user_id', 'key'])

        # Deleting model 'Account'
        db.delete_table(u'account_account')

        # Deleting model 'OtherServiceInfo'
        db.delete_table(u'account_otherserviceinfo')

        # Deleting model 'PasswordReset'
        db.delete_table(u'account_passwordreset')
